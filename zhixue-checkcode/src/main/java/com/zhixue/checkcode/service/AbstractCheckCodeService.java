package com.zhixue.checkcode.service;

import com.zhixue.checkcode.model.CheckCodeParamsDto;
import com.zhixue.checkcode.model.CheckCodeResultDto;
import lombok.Data;
...
public abstract class AbstractCheckCodeService implements CheckCodeService {
     ...
     * @param expire             过期时间
     * @return {@link com.zhixue.checkcode.service.AbstractCheckCodeService.GenerateResult} 生成结果
     * @author Wuxy
